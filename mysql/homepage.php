      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <button class="w3-button w3-black w3-margin-bottom" onclick="https://en.wikipedia.org/wiki/Bandarban_District">30% Off</button>
          </div>
        </div>
        <div class="w3-third w3-margin-bottom">
        ...
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <p>Praesent tincidunt sed tellus ut rutrum sed vitae justo.</p>
            <button class="w3-button w3-black w3-margin-bottom" onclick="document.getElementById('ticketModal').style.display='block'">25% Off</button>
          </div>
        </div>
      </div>
    </div>
